...
train = np.empty((16000,200),dtype="float32")
label = np.empty((16000,1),dtype="float32")
train1 = np.empty((16000,200),dtype="float32")
label1 = np.empty((16000,1),dtype="float32")
for i in range(16000):
    train[i,:] = a1[12000+i:12200+i,-1]
    label[i] = a1[12200+i,2]    
...
def run_network(model=None, epochs=0):
    ...
    try:
        ...
        print(str(e))
    if epochs>0:
        model.save('test12a.h5')
    return model, predicted

[mo, pred] = run_network(model='test12a.h5', epochs = 10)

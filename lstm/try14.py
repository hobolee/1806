# -*- coding: utf-8 -*-
"""
Created on Wed Jun 20 18:00:16 2018
...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 20 12:54:31 2018
...
def run_network(model=None, epochs=0):
    ...
    try:
        ...
        print(str(e))
    if epochs>0:
        model.save('test14a.h5')
    return model, predicted

[mo, pred] = run_network(model='test14a.h5', epochs = 100)

# -*- coding: utf-8 -*-
"""
Created on Sat Jul 14 10:18:00 2018
...
for i in range(1, 25):
    if i < 13:
        ...
        if i < 22:
            locals()['a'+str(i)]=np.loadtxt(r'D:\1806\DATA FILES\C40'+str(i-12)+'-Full.txt')
        else:
            locals()['a'+str(i)]=np.loadtxt(r'D:\1806\DATA FILES\C4'+str(i-12)+'-Full.txt')
...
for i in range(12):
    for j in range(55000):
        if i==11:
            ...
            y_test[j] = a24[300+j,2] 
        else:
            X_train[55000*i+j,:] = locals()['a'+str(i+1)][0+j:300+j:3,-1]
            y_train[55000*i+j,:] = locals()['a'+str(i+13)][300+j,2]
...
def run_network(model=None, epochs=0):
    ...
    try:
        ...
        print(str(e))
    if epochs>0:
        model.save('test33b.h5')
    return model, predicted

[mo, pred] = run_network(model='test33b.h5', epochs =0)

# -*- coding: utf-8 -*-
"""
Created on Wed Jul 25 15:12:16 2018
...
for i in range(12):
    for j in range(55000):
        if i==11:
            ...
            y_test[j] = a24[543+j,4] 
        else:
            X_train[55000*i+j,:] = locals()['a'+str(i+1)][0+j:300+j:3,-1]
            y_train[55000*i+j,:] = locals()['a'+str(i+13)][543+j,4]
...
def run_network(model=None, epochs=0):
    ...
    try:
        ...
        print(str(e))
    if epochs>0:
        model.save('test35a.h5')
    return model, predicted

#[mo, pred] = run_network(model='test34a.h5', epochs =0)

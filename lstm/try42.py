# -*- coding: utf-8 -*-
"""
Created on Wed Aug  1 21:22:39 2018
...
for i in range(1, 13):
    if i < 10:
        locals()['a'+str(i)]=np.loadtxt(r'D:\1806\data_aligned\C40'+str(i)+'.txt', skiprows = 0)
    else:
        locals()['a'+str(i)]=np.loadtxt(r'D:\1806\data_aligned\C4'+str(i)+'.txt', skiprows = 0)
#cal = a6[:,1]
#surge = a18[:,2]
...
def run_network(model=None, epochs=0):
    ...
    try:
        ...
        print(str(e))
    if epochs>0:
        model.save('test42a.h5')
    return model, predicted

[mo, pred] = run_network(model='test42a.h5', epochs =10)
#[mo, pred] = run_network(model=None, epochs = 36)

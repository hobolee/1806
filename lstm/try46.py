...
for i in range(1, 41):
    if i < 41:
        if i < 10:
            locals()['a'+str(i)]=np.loadtxt(r'C:\Users\29860\Documents\1806\data_aligned\C30'+str(i)+'.txt', skiprows = 0)
        elif i < 17:
            locals()['a'+str(i)]=np.loadtxt(r'C:\Users\29860\Documents\1806\data_aligned\C3'+str(i)+'.txt', skiprows = 0)
        elif i < 26:
            locals()['a'+str(i)]=np.loadtxt(r'C:\Users\29860\Documents\1806\data_aligned\C50'+str(i-16)+'.txt', skiprows = 0)
        else:
            locals()['a'+str(i)]=np.loadtxt(r'C:\Users\29860\Documents\1806\data_aligned\C5'+str(i-16)+'.txt', skiprows = 0)
...
for i in range(1, 41):
    for j in range(42500):
        if i==40:
            ...
            y_test[j] = a40[300+4*j,4] 
        else:
            X_train[42500*(i-1)+j,:] = locals()['a'+str(i+1)][0+4*j:300+4*j:4,1]
            y_train[42500*(i-1)+j,:] = locals()['a'+str(i+1)][300+4*j,4]
#for i in range(1, 40):
#    del locals()['a'+str(i)]
#    del locals()['b'+str(i)] 
